...
`,He="_container_1sx8w_1",Je="_svg_1sx8w_6",Ke="_txt_1sx8w_12",C={container:He,svg:Je,txt:Ke},Qe=({selectedDate:n,onChange:l,minDate:r,maxDate:h})=>{const x=m.forwardRef(({onClick:d},t)=>e.jsxs("div",{onClick:d,ref:t,className:C.container,children:[e.jsx("div",{className:C.txt,children:U(n,"dd/MM/yyyy")}),e.jsx("div",{children:e.jsx("svg",{className:C.svg,children:e.jsx("use",{href:`${p}#icon-calendar-bage`})})})]}));return e.jsxs(e.Fragment,{children:[e.jsx(O,{selected:n,onChange:l,customInput:e.jsx(x,{}),minDate:r,maxDate:h,dateFormat:"dd MM yyyy",calendarStartDay:1}),e.jsx(Ye,{})]})},Xe="_input_nkglg_1",Ze="_arrowLeft_nkglg_8",et="_arrowRight_nkglg_17",tt="_box_nkglg_21",rt="_opacity_nkglg_27",D={input:Xe,arrowLeft:Ze,arrowRight:et,box:tt,opacity:rt},st=({minDate:n,maxDate:l,selectedDate:r,setSelectedDate:h,handleToNextDay:x,handleToPreviousDay:d,additionalIconClass:t})=>{const o=t==="opacity-left",_=t==="opacity-right";return e.jsxs("div",{className:D.box,children:[e.jsx(Qe,{minDate:n,maxDate:l,selectedDate:r,onChange:h}),e.jsxs("div",{children:[e.jsx("button",{type:"button",className:D.arrowLeft,onClick:d,style:o?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${p}#icon-chevron-left`})})}),e.jsx("button",{type:"button",onClick:x,className:D.arrowRight,style:_?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${p}#icon-chevron-right`})})})]})]})},at="_container_166rm_1",it="_titleCont_166rm_18",nt="_itemsCont_166rm_25",N={container:at,titleCont:it,itemsCont:nt};function xt(){const n=A(),{date:l}=F(),r=$(),{user:h}=I(),[x,d]=m.useState("opacity-right"),t=c=>c.toLocaleDateString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric"}).replace(/\//g,"-");m.useEffect(()=>{r(b(l))},[r,l]);const o=new Date,_=t(o),[j,y]=m.useState(new Date),f=k(W(h.createdAt)),{doneExercises:P,consumedProducts:T}=E();m.useEffect(()=>{r(b(_)),n(`/diary/${_}`)},[r,_]),m.useEffect(()=>{r(z())},[r]);const v=c=>{const u=t(c);n(`/diary/${u}`),r(b(u))},q=()=>{const c=G(j,1),u=k(W(h.createdAt));if(c.getDate()===u.getDate()){d("opacity-left"),y(c),v(c);return}c.getTime()<u.getTime()||(d(""),y(c),v(c))},B=()=>{const c=V(j,1),u=k(new Date);if(c.getDate()===u.getDate()){d("opacity-right"),y(c),v(c);return}c>u||(d(""),y(c),v(c))},S=c=>{y(c),v(c)};return e.jsxs("div",{className:`${N.backGround} layoutContainer`,children:[e.jsxs("div",{className:N.titleCont,children:[e.jsx(K,{title:"Diary"}),e.jsx(st,{minDate:f,maxDate:o,selectedDate:j,setSelectedDate:S,handleToNextDay:B,handleToPreviousDay:q,additionalIconClass:x})]}),e.jsxs("div",{className:N.container,children:[e.jsxs("div",{className:N.itemsCont,children:[e.jsx(ve,{products:T,selectedDate:_}),e.jsx(Oe,{exercises:P,selectedDate:_})]}),e.jsx(Ve,{})]})]})}export{xt as default};
