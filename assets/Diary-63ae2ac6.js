...
`,He="_container_1sx8w_1",Je="_svg_1sx8w_6",Ke="_txt_1sx8w_12",k={container:He,svg:Je,txt:Ke},Qe=({selectedDate:n,onChange:l,minDate:r,maxDate:h})=>{const x=m.forwardRef(({onClick:d},t)=>e.jsxs("div",{onClick:d,ref:t,className:k.container,children:[e.jsx("div",{className:k.txt,children:U(n,"dd/MM/yyyy")}),e.jsx("div",{children:e.jsx("svg",{className:k.svg,children:e.jsx("use",{href:`${p}#icon-calendar-bage`})})})]}));return e.jsxs(e.Fragment,{children:[e.jsx(O,{selected:n,onChange:l,customInput:e.jsx(x,{}),minDate:r,maxDate:h,dateFormat:"dd MM yyyy",calendarStartDay:1}),e.jsx(Ye,{})]})},Xe="_input_nkglg_1",Ze="_arrowLeft_nkglg_8",et="_arrowRight_nkglg_17",tt="_box_nkglg_21",rt="_opacity_nkglg_27",C={input:Xe,arrowLeft:Ze,arrowRight:et,box:tt,opacity:rt},st=({minDate:n,maxDate:l,selectedDate:r,setSelectedDate:h,handleToNextDay:x,handleToPreviousDay:d,additionalIconClass:t})=>{const c=t==="opacity-left",_=t==="opacity-right";return e.jsxs("div",{className:C.box,children:[e.jsx(Qe,{minDate:n,maxDate:l,selectedDate:r,onChange:h}),e.jsxs("div",{children:[e.jsx("button",{type:"button",className:C.arrowLeft,onClick:d,style:c?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${p}#icon-chevron-left`})})}),e.jsx("button",{type:"button",onClick:x,className:C.arrowRight,style:_?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${p}#icon-chevron-right`})})})]})]})},at="_container_166rm_1",it="_titleCont_166rm_18",nt="_itemsCont_166rm_25",N={container:at,titleCont:it,itemsCont:nt};function xt(){const n=A(),{date:l}=F(),r=E(),{user:h}=I(),[x,d]=m.useState("opacity-right"),t=o=>o.toLocaleDateString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric"}).replace(/\//g,"-");m.useEffect(()=>{r(b(l))},[r,l]);const c=new Date,_=t(c),[g,u]=m.useState(new Date),f=$(W(h.createdAt)),{doneExercises:P,consumedProducts:T}=D();m.useEffect(()=>{r(b(_)),n(`/diary/${_}`)},[r,_]),m.useEffect(()=>{r(z())},[r]);const j=o=>{const v=t(o);n(`/diary/${v}`),r(b(v))},q=()=>{const o=G(g,1),v=$(W(h.createdAt));if(o.getDate()===v.getDate()){d("opacity-left"),u(o),j(o);return}o.getTime()<v.getTime()||(d(""),u(o),j(o))},B=()=>{const o=V(g,1);if(o.getDate()===c.getDate()){d("opacity-right"),u(o),j(o);return}o>c||(d(""),u(o),j(o))},S=o=>{u(o),j(o)};return e.jsxs("div",{className:`${N.backGround} layoutContainer`,children:[e.jsxs("div",{className:N.titleCont,children:[e.jsx(K,{title:"Diary"}),e.jsx(st,{minDate:f,maxDate:c,selectedDate:g,setSelectedDate:S,handleToNextDay:B,handleToPreviousDay:q,additionalIconClass:x})]}),e.jsxs("div",{className:N.container,children:[e.jsxs("div",{className:N.itemsCont,children:[e.jsx(ve,{products:T,selectedDate:_}),e.jsx(Oe,{exercises:P,selectedDate:_})]}),e.jsx(Ve,{})]})]})}export{xt as default};
