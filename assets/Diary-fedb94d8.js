...
`,it="_container_1rs47_1",nt="_svg_1rs47_6",ct="_txt_1rs47_19",I={container:it,svg:nt,txt:ct},ot=({selectedDate:i,onChange:a,minDate:l,maxDate:p})=>{const h=_.forwardRef(({onClick:x},d)=>e.jsxs("div",{onClick:x,ref:d,className:I.container,children:[e.jsx("div",{className:I.txt,children:J(i,"dd/MM/yyyy")}),e.jsx("div",{children:e.jsx("svg",{className:I.svg,children:e.jsx("use",{href:`${m}#calendar`})})})]}));return e.jsxs(e.Fragment,{children:[e.jsx(K,{selected:i,onChange:a,customInput:e.jsx(h,{}),minDate:l,maxDate:p,dateFormat:"dd MM yyyy",calendarStartDay:1}),e.jsx(at,{})]})},lt="_input_1i3a6_1",dt="_arrowLeft_1i3a6_8",pt="_arrowRight_1i3a6_17",ht="_box_1i3a6_21",mt="_opacity_1i3a6_28",xt="_svg_1i3a6_31",k={input:lt,arrowLeft:dt,arrowRight:pt,box:ht,opacity:mt,svg:xt},_t=({minDate:i,maxDate:a,selectedDate:l,setSelectedDate:p,handleToNextDay:h,handleToPreviousDay:x,additionalIconClass:d})=>{const t=d==="opacity-left",o=d==="opacity-right";return e.jsxs("div",{className:k.box,children:[e.jsx(ot,{minDate:i,maxDate:a,selectedDate:l,onChange:p}),e.jsxs("div",{children:[e.jsx("button",{type:"button",className:k.arrowLeft,onClick:x,style:t?{opacity:.2}:null,children:e.jsx("svg",{className:k.svg,width:"16",height:"16",children:e.jsx("use",{href:`${m}#icon-chevron-left1`})})}),e.jsx("button",{type:"button",onClick:h,className:k.arrowRight,style:o?{opacity:.2}:null,children:e.jsx("svg",{className:k.svg,width:"16",height:"16",children:e.jsx("use",{href:`${m}#icon-chevron-right1`})})})]})]})},ut="_container_166rm_1",yt="_titleCont_166rm_18",gt="_itemsCont_166rm_25",E={container:ut,titleCont:yt,itemsCont:gt};function kt(){const i=G(),a=U(),{date:l}=V(),p=z(),{user:h}=S(),[x,d]=_.useState("opacity-right"),t=c=>c.toLocaleDateString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric"}).replace(/\//g,"-");_.useEffect(()=>{p(Y())},[p]);const o=new Date,f=t(o),[N,g]=_.useState(l?B(l,"dd-MM-yyyy",new Date):new Date),y=L(R(h.createdAt)),{doneExercises:D,consumedProducts:b}=C();_.useEffect(()=>{l?(p(W(l)),i(`/diary/${l}`)):(p(W(f)),i(`/diary/${f}`));const c=R(h.createdAt),u=l?B(l,"dd-MM-yyyy",new Date):o,q=t(o),O=t(c),T=t(u);d(T===q?"opacity-right":T===O?"opacity-left":"")},[p,l,f,i,h.createdAt]);const w=c=>{const u=t(c);i(`/diary/${u}`),p(W(u))},$=()=>{const c=Q(N,1),u=L(R(h.createdAt));if(c.getDate()===u.getDate()){g(c),w(c);return}c.getTime()<u.getTime()||(g(c),w(c))},A=()=>{const c=X(N,1),u=L(new Date);if(c.getDate()===u.getDate()){g(c),w(c);return}c>u||(g(c),w(c))},M=c=>{g(c),w(c)};return e.jsxs("div",{className:`${E.backGround} layoutContainer`,children:[e.jsxs("div",{className:E.titleCont,children:[e.jsx(se,{title:"Diary"}),e.jsx(_t,{minDate:y,maxDate:o,selectedDate:N,setSelectedDate:M,handleToNextDay:A,handleToPreviousDay:$,additionalIconClass:x})]}),e.jsxs("div",{className:E.container,children:[e.jsxs("div",{className:E.itemsCont,children:[e.jsx(We,{products:b,location:a}),e.jsx(tt,{exercises:D,location:a})]}),e.jsx(rt,{})]})]})}export{kt as default};
