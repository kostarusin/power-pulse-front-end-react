...
`,tt="_container_1sx8w_1",rt="_svg_1sx8w_6",st="_txt_1sx8w_12",R={container:tt,svg:rt,txt:st},at=({selectedDate:a,onChange:n,minDate:l,maxDate:d})=>{const h=m.forwardRef(({onClick:_},p)=>e.jsxs("div",{onClick:_,ref:p,className:R.container,children:[e.jsx("div",{className:R.txt,children:K(a,"dd/MM/yyyy")}),e.jsx("div",{children:e.jsx("svg",{className:R.svg,children:e.jsx("use",{href:`${x}#icon-calendar-bage`})})})]}));return e.jsxs(e.Fragment,{children:[e.jsx(Q,{selected:a,onChange:n,customInput:e.jsx(h,{}),minDate:l,maxDate:d,dateFormat:"dd MM yyyy",calendarStartDay:1}),e.jsx(et,{})]})},it="_input_1bfnf_1",nt="_arrowLeft_1bfnf_8",ct="_arrowRight_1bfnf_17",ot="_box_1bfnf_21",lt="_opacity_1bfnf_28",I={input:it,arrowLeft:nt,arrowRight:ct,box:ot,opacity:lt},dt=({minDate:a,maxDate:n,selectedDate:l,setSelectedDate:d,handleToNextDay:h,handleToPreviousDay:_,additionalIconClass:p})=>{const t=p==="opacity-left",o=p==="opacity-right";return e.jsxs("div",{className:I.box,children:[e.jsx(at,{minDate:a,maxDate:n,selectedDate:l,onChange:d}),e.jsxs("div",{children:[e.jsx("button",{type:"button",className:I.arrowLeft,onClick:_,style:t?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${x}#icon-chevron-left`})})}),e.jsx("button",{type:"button",onClick:h,className:I.arrowRight,style:o?{opacity:.2}:null,children:e.jsx("svg",{width:"16",height:"16",children:e.jsx("use",{href:`${x}#icon-chevron-right`})})})]})]})},pt="_container_166rm_1",ht="_titleCont_166rm_18",xt="_itemsCont_166rm_25",D={container:pt,titleCont:ht,itemsCont:xt};function jt(){const a=U(),n=G(),{date:l}=V(),d=T(),{user:h}=z(),[_,p]=m.useState("opacity-right"),t=c=>c.toLocaleDateString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric"}).replace(/\//g,"-");m.useEffect(()=>{d(Y())},[d]);const o=new Date,j=t(o),[f,g]=m.useState(l?P(l,"dd-MM-yyyy",new Date):new Date),y=W(L(h.createdAt)),{doneExercises:C,consumedProducts:b}=k();m.useEffect(()=>{l?(d($(l)),a(`/diary/${l}`)):(d($(j)),a(`/diary/${j}`));const c=L(h.createdAt),u=l?P(l,"dd-MM-yyyy",new Date):o,M=t(o),O=t(c),B=t(u);p(B===M?"opacity-right":B===O?"opacity-left":"")},[d,l,j,a,h.createdAt]),m.useEffect(()=>{d(H())},[d]);const w=c=>{const u=t(c);a(`/diary/${u}`),d($(u))},E=()=>{const c=X(f,1),u=W(L(h.createdAt));if(c.getDate()===u.getDate()){g(c),w(c);return}c.getTime()<u.getTime()||(g(c),w(c))},A=()=>{const c=Z(f,1),u=W(new Date);if(c.getDate()===u.getDate()){g(c),w(c);return}c>u||(g(c),w(c))},q=c=>{g(c),w(c)};return e.jsxs("div",{className:`${D.backGround} layoutContainer`,children:[e.jsxs("div",{className:D.titleCont,children:[e.jsx(se,{title:"Diary"}),e.jsx(dt,{minDate:y,maxDate:o,selectedDate:f,setSelectedDate:q,handleToNextDay:A,handleToPreviousDay:E,additionalIconClass:_})]}),e.jsxs("div",{className:D.container,children:[e.jsxs("div",{className:D.itemsCont,children:[e.jsx(Ee,{products:b,location:n}),e.jsx(Qe,{exercises:C})]}),e.jsx(Ze,{})]})]})}export{jt as default};
